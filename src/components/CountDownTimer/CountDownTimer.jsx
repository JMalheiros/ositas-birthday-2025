...
import image2 from "../../img/title2.png";

const CountdownTimer = () => {
  const eventDate = useMemo(() => new Date(2025, 0, 7), []);
  const spEventDate = useMemo(() => new Date("January 1, 2025, 7:30:00"), []);
  ...
  return (
    <div className={"countdown-page" + (timerSelected === "birthday" ? "" : "-dark")}>
      <div className="countdown-timer-container">
        <div className="countdown-image-container">
          <img src={timerSelected === "birthday" ? image : image2} alt="Title" className="countdown-image" height="200px" />
        </div>
        <p className="countdown-title">
          Contagem para o {timerSelected === "birthday" ? "aniversário" : "primeiro evento"}
        </p>
